...
# Add/remove here only when you want to change coverage.
COUNTRIES = [
    ("AL", "albania"),
    ("DZ", "algeria"),
    ("AO", "angola"),
...
def main():
    ...
    for index, (iso2, slug) in enumerate(COUNTRIES, start=1):
        print("=" * 80)
        ...
        # write progress after every country so partial results are preserved
